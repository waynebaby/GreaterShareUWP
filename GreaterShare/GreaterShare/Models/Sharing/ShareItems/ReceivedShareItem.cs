...
namespace GreaterShare.Models.Sharing.ShareItems
{
    ...
    public class ReceivedShareItem : BindableBase<ReceivedShareItem>
    {
        ...
        public static bool operator !=(ReceivedShareItem lhs, ReceivedShareItem rhs)
        {
            object ol, or;
            PrepareCompare(lhs, rhs, out ol, out or);
        ...
        private static void PrepareCompare(ReceivedShareItem lhs, ReceivedShareItem rhs, out object ol, out object or)
        {
            ol = ((object)lhs);
            or = ((object)rhs);
            if (ol != null)
            {
                ol = lhs.IsEmptyPlaceHoder ? null : ol;
            }


            if (or != null)
            {
                or = rhs.IsEmptyPlaceHoder ? null : or;
            }
        }
        ...
        public bool IsEmptyPlaceHoder { get; set; }
